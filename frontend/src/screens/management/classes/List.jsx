        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                setClasses(classes.map(x => {
                    if (x.classId === id) { x.isDeleting = true; }
                    return x;
                }));
    ...
    return (
        <div>
            ...
            <div className="d-flex">
                <button onClick={addClass} className="btn btn-sm btn-success mb-2 mr-2">Add Class</button> 
            ...
            <Modal title={addMode ? "Add Class" : "Update Class"} show={openModal} onHide={() => setOpenModal(false)} >
                <AddEdit onHide={onHide} id={addMode ? 0 : id} />
            </Modal>

            <Modal title={"Import Excel"} show={openImportModal} onHide={() => setOpenImportModal(false)} >
                <ExcelUpload getClass={getClass} setOpenImportModal={setOpenImportModal}/>
            </Modal>
        </div>
    );
}
