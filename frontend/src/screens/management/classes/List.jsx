  ...
  return (
    <div>
      ...
      <div className="d-flex">
        ...
        <a href="https://drive.google.com/uc?id=1uXnDX0LoXXIMduBBjIfQi9jhLOTk5a0Z" rel="noopener noreferrer" className="mr-2 btn btn-sm btn-warning mb-2">Excel Template</a>
        <button
